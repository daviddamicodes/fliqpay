...
export const detailsReducer = (state = initialState, {type, payload}) => {
    switch (type) {
        case ActionTypes.SET_PAYOUT:
            const {youSend, recipientGets, transferFee, convertedAmount, guaranteedRate} = payload
            // return {...state, youSend: payload.youSend, recipientGets: payload.recipientGets, transferFee: payload.transferFee}
            return {...state, youSend, recipientGets, transferFee, convertedAmount, guaranteedRate}
