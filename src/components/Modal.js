                            ...
                            (state.fullName !== "") ? (
                                <div className="w-72 bg-white text-center p-4 rounded-lg relative">
                                    <div className="py-4 px-8 border-gray-1 border-2 appearance-none mb-4">
                                        ...
                                        <h1 className="text-purple-900 text-2xl font-medium">{numFormat(state.youSend)}<span className="text-xs font-medium ml-1">{state.fromCurrency}</span></h1>
                                    </div>
                                    ...
                                    <div className="flex mt-3">
                                        <button className="font-medium text-xs py-3 px-4 bg-white text-white bg-mid-blue flex-grow rounded-md" onClick={paymentAlert}>Ok</button>
                                    </div>
                                    <div className="bg-white h-8 w-8 rounded-full border-gray-1 border-2 absolute -top-3 -right-3 cursor-pointer flex items-center justify-center" onClick={openModal} >   
                                    ...
                                    <div className="w-72 bg-white text-center p-4 rounded-lg relative">
                                        <div className="py-8 px-8 border-gray-1 border-2 appearance-none">
                                            ...
                                            <p className="text-gray-400 text-1xs font-normal">Kindly confirm that all feilds are correctly filled.</p>
                                        </div>
                                        <div className="flex mt-3">
                                            <button className="font-medium text-xs py-3 px-4 bg-white text-white bg-mid-blue flex-grow rounded-md" onClick={handleFailed}>Return</button>
                                        </div>
                                        <div className="bg-white h-8 w-8 rounded-full border-gray-1 border-2 absolute -top-3 -right-3 cursor-pointer flex items-center justify-center" onClick={openModal} >   
                                            <MdClose className="text-gray-400"/>
                                        </div>
